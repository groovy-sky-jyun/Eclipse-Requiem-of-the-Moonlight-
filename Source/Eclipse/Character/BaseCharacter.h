...
public:
	...
	virtual void TakeCombatDamage_Implementation(const FCombatDamage& DamageInfo, AActor* Attacker) override final;
...
protected:
	...
	virtual void OnDamaged(const FCombatDamage& DamageInfo, AActor* Attacker, bool bLethal) {};
